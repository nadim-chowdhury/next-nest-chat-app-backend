  ...
  implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect
{
  ...
  async handleConnection(client: Socket) {
    ...
    if (userId) {
      ...
      console.log(`Client connected: ${client.id}, User: ${userId} is online`);
    } else {
      console.log(`Client connected: ${client.id}, but no userId provided`);
    }
  }
  ...
  async handleDisconnect(client: Socket) {
    ...
    if (userId) {
      ...
      console.log(
        `Client disconnected: ${client.id}, User: ${userId} is offline`,
      );
    } else {
      console.log(`Client disconnected: ${client.id}, but no userId provided`);
    }
  }
